...
| --------------- | ------------------------------------------------------------------------------------------------------------------------------------------ |:--------:|
| `type`          | Column type. Must be a `Phalcon\Db\Column` constant (see below)                                                                          |   Nie    |
...
| `primary`       | Sets this column as a primary key index using `columnName_pkey` as identifier. Type - `BOOLEAN`                                            |   Tak    |

<div class='article-menu'>
  <ul>
    <li>
      <a href="#requirements">Requerimientos</a> <ul>
        <li>
      ...
      <a href="#installation">Instalación</a> <ul>
        <li>
          <a href="#installation-linux">Linux</a> <ul>
            <li>
              <a href="#installation-linux-debian">Distribuciones basadas en DEB (Debian, Ubuntu, etc)</a> <ul>
                <li>
                  <a href="#installation-linux-debian-repository">Instalación desde el repositorio</a> <ul>
                    <li>
                ...
                <li>
                  <a href="#installation-linux-debian-phalcon">Instalación de Phalcon</a> <ul>
                    <li>
            ...
            <li>
              <a href="#installation-linux-rpm">Distribuciones basadas en RPM (CentOS, Fedora, etc.)</a> <ul>
                <li>
                  <a href="#installation-linux-rpm-repository">Instalación desde el repositorio</a> <ul>
                    <li>
                ...
                <li>
                  <a href="#installation-linux-rpm-phalcon">Instalación de Phalcon</a> <ul>
                    <li>
...
- [Memcache](http://php.net/manual/en/book.memcache.php), [Memcached](http://php.net/manual/en/book.memcached.php) u otros adaptadores de caché correspondiente dependiendo de su uso de caché.
...
Para instalar Phalcon en linux, necesitará agregar nuestro repositorio en su distribuición y después instalarlo.
...
Si no desea usar nuestro repositorio de packagecloud.io, siempre puede utilizar el ofrecido por [Ondřej Surý](https://launchpad.net/~ondrej/+archive/ubuntu/php/).
...
Remi mantiene un excelente repositorio de instalaciones basadas en RPM. Puede encontrar instrucciones sobre cómo activar su distribución [aquí](https://blog.remirepo.net/pages/Config-en)
...
En un sistema Mac OS X puede compilar e instalar la extensión con `brew`, `macports` o el código fuente:
...
Compilar desde código fuente es similar a la mayoría de los entornos (Linux/Mac).
...
Si el instalador automático falla te puede generar la extensión manualmente

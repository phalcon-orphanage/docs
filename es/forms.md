...
Un formulario también es capaz de filtrar los datos antes de validarlos. Puede definir filtros en cada elemento:
...
Una vez que el formulario es impreso, si no hay ningún valor por defecto asignado a los elementos se usarán los provistos por la entidad:

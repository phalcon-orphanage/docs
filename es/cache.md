...
| `Phalcon\Cache\Backend\Memcache`     | Almacena los datos en un servidor memcache.                               | [Memcache](http://www.php.net/memcache)   | [Memcache](http://pecl.php.net/package/memcache)   |

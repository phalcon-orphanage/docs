...
El registrador de flujo escribe mensajes en una secuencia registrada válida en PHP. Una lista de transmisiones está disponible [aquí](http://php.net/manual/en/wrappers.php>):

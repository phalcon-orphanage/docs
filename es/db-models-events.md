...
| Deleting              | beforeDelete             |              SI              | Runs before the delete operation is made                                                                                                         |
...
| Inserting             | beforeValidationOnCreate |             YES              | Se ejecuta antes de que se validan los campos no nulos/cadenas vacías o llaves foráneas, solo cuando se realiza una operación de inserción       |

...
## Arrays Nativos
El primer ejemplo muestra como convertir un arreglo en un objecto `Phalcon\Config`. Esta opción ofrece el mejor rendimiento ya que no se leen archivos durante esta solicitud.

...
## 命名規則
Phalconイベントは名前空間を使用して衝突を避けます。 Each component in Phalcon occupies a different event namespace, and you are free to create your own as you see fit. イベント名は `component:event` としてフォーマットされます。 For example, as [Phalcon\Db][db] occupies the `db` namespace, its `afterQuery` event's full name is `db:afterQuery`.
...
| [ビュー](views)                | `view:afterCompile`                  | Volt                                                    |
| [ビュー](views)                | `view:afterRender`                   | ビュー                                                     |
| [ビュー](views)                | `view:afterRenderView`               | ビュー                                                     |
| [ビュー](views)                | `view:beforeCompile`                 | Volt                                                    |
| [ビュー](views)                | `view:beforeRender`                  | ビュー                                                     |
| [ビュー](views)                | `view:beforeRenderView`              | View, View Engine Path                                  |
| [ビュー](views)                | `view:notFoundView`                  | View, View Engine Path                                  |

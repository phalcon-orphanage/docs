...
Additionally, "Criteria" ignores all the $_POST variables that do not match any field in the table. Also, values are automatically escaped using "bound parameters".

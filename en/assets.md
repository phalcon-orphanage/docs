...
Remote resources are those such as common libraries like [jQuery][jquery], [Bootstrap][bootstrap], etc. that are provided by a [CDN][cdn].
...
### Custom Filters
In addition to the built-in filters, you can create your own filters. These can take advantage of existing and more advanced tools like [YUI][yui], [Sass][sass], [Closure][closure], etc.:

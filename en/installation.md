...
- [Requirements](3.1/installation.md#requirements)
    - [Hardware](3.1/installation.md#requirements-hardware)
    - [Software](3.1/installation.md#requirements-software)
- [Installation](3.1/installation.md#installation)
    - [Linux](3.1/installation.md#installation-linux)
        - [DEB based distributions (Debian, Ubuntu, etc.)](3.1/installation.md#installation-linux-debian)
            - [Repository installation](3.1/installation.md#installation-linux-debian-repository)
                - [Stable releases](3.1/installation.md#installation-linux-debian-repository-stable)
                - [Nightly releases](3.1/installation.md#installation-linux-debian-repository-nightly)
            - [Phalcon installation](3.1/installation.md#installation-linux-debian-phalcon)
                - [PHP 5.x](3.1/installation.md#installation-linux-debian-phalcon-php5)
                - [PHP 7](3.1/installation.md#installation-linux-debian-phalcon-php7)
            - [Additional PPAs](3.1/installation.md#installation-linux-debian-other-ppa)
        - [RPM based distributions (CentOS, Fedora, etc.)](3.1/installation.md#installation-linux-rpm)
            - [Repository installation](3.1/installation.md#installation-linux-rpm-repository)
                - [Stable releases](3.1/installation.md#installation-linux-rpm-repository-stable)
                - [Nightly releases](3.1/installation.md#installation-linux-rpm-repository-nightly)
            - [Phalcon installation](3.1/installation.md#installation-linux-rpm-phalcon)
                - [PHP 5.x](3.1/installation.md#installation-linux-rpm-phalcon-php5)
                - [PHP 7](3.1/installation.md#installation-linux-rpm-phalcon-php7)
            - [Additional RPMs](installation-linux-rpm-other-rpm)
        - [FreeBSD](3.1/installation.md#installation-freebsd)
        - [Gentoo](3.1/installation.md#installation-linux-gentoo)
    - [MacOS](3.1/installation.md#installation-macos)
        - [Brew](3.1/installation.md#installation-macos-brew)
        - [MacPorts](3.1/installation.md#installation-macos-macports)
    - [Windows](3.1/installation.md#installation-windows)
    - [Compile from sources](3.1/installation.md#installation-sources)
    - [Advanced Compilation](3.1/installation.md#installation-sources-advanced)

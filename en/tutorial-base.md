...
Next, we register a base URI so that all URIs generated is correct. This will become important later on in this tutorial when we use the class `Phalcon\Tag` to generate a hyperlink.

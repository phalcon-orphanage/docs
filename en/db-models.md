...
- [Working with Models](3.1/db-models.md#working-with)
    - [Creating Models](3.1/db-models.md#creating)
        - [Public properties vs. Setters/Getters](3.1/db-models.md#properties-setters-getters)
    - [Understanding Records To Objects](3.1/db-models.md#records-to-objects)
    - [Finding Records](3.1/db-models.md#finding-records)
        - [Model Resultsets](3.1/db-models.md#resultsets)
        - [Filtering Resultsets](3.1/db-models.md#filters)
        - [Binding Parameters](3.1/db-models.md#binding-parameters)
    - [Initializing/Preparing fetched records](3.1/db-models.md#preparing-records)
    - [Generating Calculations](3.1/db-models.md#calculations)
    - [Creating/Updating Records](3.1/db-models.md#create-update-records)
        - [Create/Update with Confidence](3.1/db-models.md#create-update-with-confidence)
    - [Deleting Records](3.1/db-models.md#delete-records)
    - [Hydration Modes](3.1/db-models.md#hydration-modes)
    - [Auto-generated identity columns](3.1/db-models.md#identity-columns)
    - [Skipping Columns](3.1/db-models.md#skipping-columns)
    - [Dynamic Updates](3.1/db-models.md#dynamic-updates)
    - [Independent Column Mapping](3.1/db-models.md#column-mapping)
    - [Record Snapshots](3.1/db-models.md#record-snapshots)
    - [Pointing to a different schema](3.1/db-models.md#different-schemas)
    - [Setting multiple databases](3.1/db-models.md#multiple-databases)
    - [Injecting services into Models](3.1/db-models.md#injecting-services-into-models)
    - [Disabling/Enabling Features](3.1/db-models.md#disabling-enabling-features)
    - [Stand-Alone component](3.1/db-models.md#stand-alone-component)

...
- [Creating a Micro Application](3.1/application-micro.md#creating-micro-application)
- [Routing](3.1/application-micro.md#routing)
    - [Setup](3.1/application-micro.md#routing-setup)
        - [Application object](3.1/application-micro.md#routing-setup-application)
        - [Router object](3.1/application-micro.md#routing-setup-router)
    - [Rewrite Rules](3.1/application-micro.md#rewrite-rules)
    - [Handlers](3.1/application-micro.md#routing-handlers)
        - [Definitions](3.1/application-micro.md#routing-handlers-definitions)
            - [Anonymous Function](3.1/application-micro.md#routing-handlers-anonymous-function)
            - [Function](3.1/application-micro.md#routing-handlers-function)
            - [Static Method](3.1/application-micro.md#routing-handlers-static-method)
            - [Method in an Object](3.1/application-micro.md#routing-handlers-object-method)
            - [Controllers](3.1/application-micro.md#routing-handlers-controllers)
        - [Lazy Loading](3.1/application-micro.md#routing-handlers-controllers-lazy-loading)
            - [Use case](3.1/application-micro.md#routing-handlers-controllers-lazy-loading-use-case)
        - [Not Found (404)](3.1/application-micro.md#routing-handlers-not-found)
    - [Methods - Verbs](3.1/application-micro.md#routing-verbs)
        - [delete](3.1/application-micro.md#routing-verb-delete)
        - [get](3.1/application-micro.md#routing-verb-get)
        - [head](3.1/application-micro.md#routing-verb-head)
        - [map](3.1/application-micro.md#routing-verb-map)
        - [options](3.1/application-micro.md#routing-verb-options)
        - [patch](3.1/application-micro.md#routing-verb-patch)
        - [post](3.1/application-micro.md#routing-verb-post)
        - [put](3.1/application-micro.md#routing-verb-put)
    - [Collections](3.1/application-micro.md#routing-collections)
    - [Parameters](3.1/application-micro.md#routing-parameters)
    - [Redirections](3.1/application-micro.md#routing-redirections)
    - [URLs for Routes](3.1/application-micro.md#routing-urls-for-routes)
- [Dependency Injector](3.1/application-micro.md#dependency-injector)
- [Responses](3.1/application-micro.md#responses)
    - [Direct output](3.1/application-micro.md#responses-direct-output)
    - [Including another file](3.1/application-micro.md#responses-include)
    - [Direct output JSON](3.1/application-micro.md#responses-direct-output-json)
    - [New Response object](3.1/application-micro.md#responses-new-response-object)
    - [Application Response](3.1/application-micro.md#responses-application-response)
    - [Return Application Response](3.1/application-micro.md#responses-return-application-response)
    - [JSON](3.1/application-micro.md#responses-json)
- [Events](3.1/application-micro.md#events)
    - [Available events](3.1/application-micro.md#events-available-events)
        - [Authentication example](3.1/application-micro.md#events-available-events-authentication)
        - [Not found example](3.1/application-micro.md#events-available-events-not-found)
- [Middleware](3.1/application-micro.md#middleware)
    - [Attached events](3.1/application-micro.md#middleware-attached-events)
        - [before](3.1/application-micro.md#middleware-attached-events-before)
        - [after](3.1/application-micro.md#middleware-attached-events-after)
        - [finish](3.1/application-micro.md#middleware-attached-events-finish)
    - [Implementation](3.1/application-micro.md#middleware-implementation)
    - [Setup](3.1/application-micro.md#middleware-setup)
    - [Events in Middleware](3.1/application-micro.md#middleware-events)
        - [API example](3.1/application-micro.md#middleware-events-api)
            - [Firewall Middleware](3.1/application-micro.md#middleware-events-api-firewall)
            - [Not Found Middleware](3.1/application-micro.md#middleware-events-api-not-found)
            - [Redirect Middleware](3.1/application-micro.md#middleware-events-api-redirect)
            - [CORS Middleware](3.1/application-micro.md#middleware-events-api-cors)
            - [Request Middleware](3.1/application-micro.md#middleware-events-api-request)
            - [Response Middleware](3.1/application-micro.md#middleware-events-api-response)
- [Models](3.1/application-micro.md#models)
- [Injecting Model Instances](3.1/application-micro.md#model-instances)
- [Views](3.1/application-micro.md#views)
- [Error Handling](3.1/application-micro.md#error-handling)
...
The [events](3.1/application-micro.md#events) that are triggered for our application also trigger inside a class that implements the `Phalcon\Mvc\Micro\MiddlewareInterface`. This offers great flexibility and power for developers since we can interact with the request process.

...
- [Overview](3.1/environments-vagrant.md#overview)
    - [Requirements](3.1/environments-vagrant.md#requirements)
    - [Packages Included](3.1/environments-vagrant.md#packages-included)
    - [Installation](3.1/environments-vagrant.md#installation)
        - [Installing the Vagrant Box](3.1/environments-vagrant.md#installation-vagrant-box)
        - [Installing the Phalcon Box](3.1/environments-vagrant.md#installation-phalcon-box)
    - [Configuring](3.1/environments-vagrant.md#installation-configuration)
        - [Setting your provider](3.1/environments-vagrant.md#installation-configuration-setting-provider)
        - [Memory and CPU](3.1/environments-vagrant.md#installation-configuration-memory-cpu)
        - [Shared folders](3.1/environments-vagrant.md#installation-configuration-shared-folders)
        - [Nginx sites](3.1/environments-vagrant.md#installation-configuration-nginx)
            - [Custom Nginx configuration](3.1/environments-vagrant.md#installation-configuration-custom-nginx)
            - [Configuring the `hosts` file](3.1/environments-vagrant.md#installation-configuration-hosts)
        - [Install additional packages](3.1/environments-vagrant.md#installation-aditional-packages)
        - [Launching the Phalcon Box](3.1/environments-vagrant.md#installation-launching-phalcon-box)
    - [Daily usage](3.1/environments-vagrant.md#daily-usage)
        - [Accessing Phalcon Box globally](3.1/environments-vagrant.md#daily-usage-accessing-box-globally)
            - [Mac || Linux](3.1/environments-vagrant.md#daily-usage-accessing-box-globally-mac-linux)
            - [Windows](3.1/environments-vagrant.md#daily-usage-accessing-box-globally-windows)
        - [Connecting via SSH](3.1/environments-vagrant.md#daily-usage-ssh)
        - [Connecting to databases](3.1/environments-vagrant.md#daily-usage-databases)
        - [Adding additional sites](3.1/environments-vagrant.md#daily-usage-additional-sites)
        - [Environment variables](3.1/environments-vagrant.md#daily-usage-environment-variables)
            - [Global variables](3.1/environments-vagrant.md#daily-usage-environment-global-variables)
            - [Site variables](3.1/environments-vagrant.md#daily-usage-environment-site-variables)
        - [Ports](3.1/environments-vagrant.md#daily-usage-ports)
            - [Forwarding additional ports](3.1/environments-vagrant.md#daily-usage-ports-forwarding)
        - [Sharing your environment](3.1/environments-vagrant.md#daily-usage-sharing-environment)
        - [Network interfaces](3.1/environments-vagrant.md#daily-usage-network-interfaces)
        - [Updating Phalcon Box](3.1/environments-vagrant.md#daily-usage-updating-box)
        - [Provider specific settings](3.1/environments-vagrant.md#daily-usage-provider-settings)
            - [VirtualBox](3.1/environments-vagrant.md#daily-usage-provider-settings-virtualbox)
        - [Mail catcher](3.1/environments-vagrant.md#daily-usage-mail-catcher)
    - [Troubleshooting](3.1/environments-vagrant.md#troubleshooting)

...
This is different to the `render` that [Phalcon\Mvc\View][mvc-view] implementation, which uses controllers and actions as parameters:
...
[mvc-view-engine-abstractengine]: api/phalcon_mvc#mvc-view-engine-abstractengine
[mvc-view-engine-engineinterface]: api/phalcon_mvc#mvc-view-engine-engineinterface
[mvc-view-engine-php]: api/phalcon_mvc#mvc-view-engine-php
[mvc-view-engine-volt]: api/phalcon_mvc#mvc-view-engine-volt
...
[mvc-viewbaseinterface]: api/phalcon_mvc#mvc-viewbaseinterface

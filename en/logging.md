...
- [Contextual Escaping](3.1/logging.md#overview)
- [Logging](3.1/logging.md#overview)
    - [Adapters](3.1/logging.md#adapters)
    - [Creating a Log](3.1/logging.md#creating)
    - [Transactions](3.1/logging.md#transactions)
    - [Logging to Multiple Handlers](3.1/logging.md#multiple-handlers)
    - [Message Formatting](3.1/logging.md#message-formatting)
        - [Line Formatter](3.1/logging.md#message-formatting-line)
        - [Implementing your own formatters](3.1/logging.md#message-formatting-custom)
    - [Adapters](3.1/logging.md#usage)
        - [Stream Logger](3.1/logging.md#usage-stream)
        - [File Logger](3.1/logging.md#usage-file)
        - [Syslog Logger](3.1/logging.md#usage-syslog)
        - [FirePHP Logger](3.1/logging.md#usage-firephp)
        - [Implementing your own adapters](3.1/logging.md#usage-custom)

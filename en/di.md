...
- [Dependency Injection / Service Location](3.1/di.md#di-service-location)
    - [DI explained](3.1/di.md#di-explained)
    - [Registering services in the Container](3.1/di.md#registering-services)
        - [Simple Registration](3.1/di.md#simple-registration)
            - [String](3.1/di.md#simple-registration-string)
            - [Class instances](3.1/di.md#class-instances)
            - [Closures/Anonymous functions](3.1/di.md#closures-anonymous-functions)
        - [Complex Registration](3.1/di.md#complex-registration)
            - [Constructor Injection](3.1/di.md#constructor-injection)
            - [Setter Injection](3.1/di.md#setter-injection)
            - [Properties Injection](3.1/di.md#properties-injection)
        - [Array Syntax](3.1/di.md#array-syntax)
    - [Resolving Services](3.1/di.md#resolving-services)
        - [Events](3.1/di.md#events)
    - [Shared services](3.1/di.md#shared-services)
    - [Manipulating services individually](3.1/di.md#manipulating-services-individually)
    - [Instantiating classes via the Service Container](3.1/di.md#instantiating-classes-service-container)
    - [Automatic Injecting of the DI itself](3.1/di.md#automatic-injecting-di-itself)
    - [Organizing services in files](3.1/di.md#organizing-services-files)
    - [Accessing the DI in a static way](3.1/di.md#accessing-di-static-way)
    - [Factory Default DI](3.1/di.md#factory-default-di)
    - [Service Name Conventions](3.1/di.md#service-name-conventions)
    - [Implementing your own DI](3.1/di.md#implementing-your-own-di)

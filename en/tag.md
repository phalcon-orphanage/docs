...
- [View Helpers (Tags)](3.1/tag.md#overview)
    - [Document Type of Content](3.1/tag.md#document-type)
    - [Creating Forms](3.1/tag.md#creating-forms)
    - [Helpers to Generate Form Elements](3.1/tag.md#helpers-for-form-elements)
    - [Making Select Boxes](3.1/tag.md#select-boxes)
    - [Assigning HTML attributes](3.1/tag.md#html-attributes)
    - [Setting Helper Values](3.1/tag.md#helper-values)
        - [From Controllers](3.1/tag.md#helper-values-form-controllers)
        - [From the Request](3.1/tag.md#helper-values-from-request)
        - [Specifying values directly](3.1/tag.md#helper-values-directly)
    - [Changing dynamically the Document Title](3.1/tag.md#changing-document-title-dynamically)
    - [Static Content Helpers](3.1/tag.md#static-content-helpers)
        - [Images](3.1/tag.md#static-content-helpers-images)
        - [Stylesheets](3.1/tag.md#static-content-helpers-stylesheets)
        - [Javascript](3.1/tag.md#static-content-helpers-javascript)
        - [HTML5 elements - generic HTML helper](3.1/tag.md#static-content-helpers-html5)
    - [Tag Service](3.1/tag.md#tag-helpers)
    - [Creating your own helpers](3.1/tag.md#custom-helpers)

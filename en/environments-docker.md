...
- [Overview](3.1/environments-docker.md#overview)
    - [Dependencies](3.1/environments-docker.md#dependencies)
    - [Services](3.1/environments-docker.md#services)
    - [Installation](3.1/environments-docker.md#installation)
        - [With Composer (recommended)](3.1/environments-docker.md#installation-composer)
        - [With Git](3.1/environments-docker.md#installation-git)
    - [Configuration](3.1/environments-docker.md#configuration)
    - [Usage](3.1/environments-docker.md#usage)
    - [Set up](3.1/environments-docker.md#setup)
    - [Logs](3.1/environments-docker.md#logs)
    - [Environment variables](3.1/environments-docker.md#environment-variables)
        - [Web environment](3.1/environments-docker.md#environment-variables-web)
        - [phpMyAdmin variables](3.1/environments-docker.md#environment-variables-phpmyadmin)
    - [Xdebug Remote debugger (PhpStorm)](3.1/environments-docker.md#xdebug)
    - [Troubleshooting](3.1/environments-docker.md#troubleshooting)
        - [Startup or linking errors](3.1/environments-docker.md#troubleshooting-startup)
        - [Full reset](3.1/environments-docker.md#troubleshooting-full-reset)
        - [Updating dependencies](3.1/environments-docker.md#troubleshooting-dependencies)
    - [Versions](3.1/environments-docker.md#versions)

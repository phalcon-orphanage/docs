...
- [Improving Performance with Cache](3.1/cache.md#overview)
    - [When to implement cache?](3.1/cache.md#implementation)
    - [Caching Behavior](3.1/cache.md#caching-behavior)
    - [Factory](3.1/cache.md#factory)
    - [Caching Output Fragments](3.1/cache.md#output-fragments)
    - [Caching Arbitrary Data](3.1/cache.md#arbitrary-data)
        - [File Backend Example](3.1/cache.md#backend-file-example)
        - [Memcached Backend Example](3.1/cache.md#backend-memcached-example)
    - [Querying the cache](3.1/cache.md#read)
    - [Deleting data from the cache](3.1/cache.md#delete)
    - [Checking cache existence](3.1/cache.md#exists)
    - [Lifetime](3.1/cache.md#lifetime)
    - [Multi-Level Cache](3.1/cache.md#multi-level)
    - [Frontend Adapters](3.1/cache.md#adapters-frontend)
        - [Implementing your own Frontend adapters](3.1/cache.md#adapters-frontend-custom)
    - [Backend Adapters](3.1/cache.md#adapters-backend)
        - [Implementing your own Backend adapters](3.1/cache.md#adapters-backend-custom)
        - [File Backend Options](3.1/cache.md#adapters-backend-file)
        - [Libmemcached Backend Options](3.1/cache.md#adapters-backend-libmemcached)
        - [Memcache Backend Options](3.1/cache.md#adapters-backend-memcache)
        - [APC Backend Options](3.1/cache.md#adapters-backend-apc)
        - [Mongo Backend Options](3.1/cache.md#adapters-backend-mongo)
        - [XCache Backend Options](3.1/cache.md#adapters-backend-xcache)
        - [Redis Backend Options](3.1/cache.md#adapters-backend-redis)

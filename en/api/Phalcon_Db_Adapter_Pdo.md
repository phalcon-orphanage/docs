...
*extends* abstract class [Phalcon\Db\Adapter](/en/3.1.2/api/Phalcon_Db_Adapter)

*implements* [Phalcon\Events\EventsAwareInterface](/en/3.1.2/api/Phalcon_Events_EventsAwareInterface), [Phalcon\Db\AdapterInterface](/en/3.1.2/api/Phalcon_Db_AdapterInterface)
...
public  **useExplicitIdValue** () inherited from [Phalcon\Db\Adapter](/en/3.1.2/api/Phalcon_Db_Adapter)

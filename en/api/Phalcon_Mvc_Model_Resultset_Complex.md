...
## Methods
public  **__construct** (*array* $columnTypes, [[Phalcon\Db\ResultInterface](/en/3.1.2/api/Phalcon_Db_ResultInterface) $result], [[Phalcon\Cache\BackendInterface](/en/3.1.2/api/Phalcon_Cache_BackendInterface) $cache])

...
[db-columninterface]: api/phalcon_db#db-columninterface
...
[db-exception]: api/phalcon_db#db-exception
[db-index]: api/phalcon_db#db-index
[db-indexinterface]: api/phalcon_db#db-indexinterface
[db-profiler]: api/phalcon_db#db-profiler
[db-profiler-item]: api/phalcon_db#db-profiler-item
[db-rawvalue]: api/phalcon_db#db-rawvalue
[db-reference]: api/phalcon_db#db-reference
[db-referenceinterface]: api/phalcon_db#db-referenceinterface
[db-result-pdo]: api/phalcon_db#db-result-pdo
[db-resultinterface]: api/phalcon_db#db-resultinterface

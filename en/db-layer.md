...
- [Database Abstraction Layer](3.1/db-layer.md#overview)
    - [Database Adapters](3.1/db-layer.md#adapters)
        - [Implementing your own adapters](3.1/db-layer.md#adapters-custom)
    - [Database Dialects](3.1/db-layer.md#dialects)
        - [Implementing your own dialects](3.1/db-layer.md#dialects-custom)
    - [Connecting to Databases](3.1/db-layer.md#connection)
    - [Setting up additional PDO options](3.1/db-layer.md#options)
    - [Finding Rows](3.1/db-layer.md#finding-rows)
    - [Binding Parameters](3.1/db-layer.md#binding-parameters)
    - [Inserting/Updating/Deleting Rows](3.1/db-layer.md#crud)
    - [Transactions and Nested Transactions](3.1/db-layer.md#transactions)
    - [Database Events](3.1/db-layer.md#events)
    - [Profiling SQL Statements](3.1/db-layer.md#profiling)
    - [Logging SQL Statements](3.1/db-layer.md#logging-statements)
    - [Implementing your own Logger](3.1/db-layer.md#logger-custom)
    - [Describing Tables/Views](3.1/db-layer.md#describing-tables)
    - [Creating/Altering/Dropping Tables](3.1/db-layer.md#tables)
        - [Creating Tables](3.1/db-layer.md#tables-create)
        - [Altering Tables](3.1/db-layer.md#tables-altering)
        - [Dropping Tables](3.1/db-layer.md#tables-dropping)

...
| ------------- | ----------------------- | ----------------------------------------------- |
| `bind`        | `масив`                 | array of the data to be bound                   |
| `bindTypes`   | `масив`                 | PDO parameter types                             |
...
| `group`       | `масив`                 | group by columns                                |
| `having`      | `string`                | having columns                                  |
| `joins`       | `масив`                 | model classes used for joins                    |
| `limit`       | `array&vert;int`    | limit for the records (i.e. `20` or `[20, 20]`) |
| `models`      | `масив`                 | model classes used                              |

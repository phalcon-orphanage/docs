...
3### Создание собственного адаптера для шаблонизатора
...
5## Внедрение сервисов в представление
...
9## События компонента представлений

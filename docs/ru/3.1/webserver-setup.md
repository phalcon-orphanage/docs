...
<h5 class='alert alert-warning'>Обратите внимание, для полного разрешения использования директив в `.htaccess` файле, в главном конфигурационном файле Apache необходимо изменить `AllowOverride None` на `AllowOverride All`. </h5>

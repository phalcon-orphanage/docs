...
All internal URIs are generated using the [url](/en/[[version]]/url) service (by default `Phalcon\Mvc\Url`). This example demonstrates how you can redirect using a route you have defined in your application:

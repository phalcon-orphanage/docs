      ...
      <a href="#overview">Improving Performance with Cache</a> <ul>
        ...
        <li>
          <a href="#adapters-backend">Backend Adapters</a> <ul>
            ...
            <li>
              <a href="#adapters-backend-memcached">Memcached Backend Options</a>
            </li>
            <li>

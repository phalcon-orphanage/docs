...
| Aplikace           | `application:afterHandleRequest`    |
| Aplikace           | `application:afterStartModule`      |
| Aplikace           | `application:beforeHandleRequest`   |
| Aplikace           | `application:beforeSendResponse`    |
| Aplikace           | `application:beforeStartModule`     |
| Aplikace           | `application:boot`                  |
| Aplikace           | `application:viewRender`            |

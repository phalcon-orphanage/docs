...
public [Phalcon\Validation\Message](/en/3.1/api/Phalcon_Validation_Message) **offsetGet** (*int* $index)
...
public  **offsetSet** (*int* $index, [Phalcon\Validation\Message](/en/3.1/api/Phalcon_Validation_Message) $message)
...
public  **appendMessages** ([Phalcon\Validation\MessageInterface](/en/3.1/api/Phalcon_Validation_MessageInterface[]) $messages)
...
public static [Phalcon\Validation\Message\Group](/en/3.1/api/Phalcon_Validation_Message_Group) **__set_state** (*array* $group)

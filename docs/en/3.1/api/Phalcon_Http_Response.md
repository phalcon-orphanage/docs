...
*implements* [Phalcon\Http\ResponseInterface](/en/3.1/api/Phalcon_Http_ResponseInterface), [Phalcon\Di\InjectionAwareInterface](/en/3.1/api/Phalcon_Di_InjectionAwareInterface)
...
public  **setHeaders** ([Phalcon\Http\Response\HeadersInterface](/en/3.1/api/Phalcon_Http_Response_HeadersInterface) $headers)
...
public  **setCookies** ([Phalcon\Http\Response\CookiesInterface](/en/3.1/api/Phalcon_Http_Response_CookiesInterface) $cookies)

Sets a cookies bag for the response externally



public [Phalcon\Http\Response\CookiesInterface](/en/3.1/api/Phalcon_Http_Response_CookiesInterface) **getCookies** ()

...
## Methods
public  **__construct** ([[Phalcon\Cache\BackendInterface](/en/3.1/api/Phalcon_Cache_BackendInterface[]) $backends])

Phalcon\\Cache\\Multiple constructor



public  **push** ([Phalcon\Cache\BackendInterface](/en/3.1/api/Phalcon_Cache_BackendInterface) $backend)

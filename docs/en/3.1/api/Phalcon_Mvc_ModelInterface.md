...
## Methods
abstract public  **setTransaction** ([Phalcon\Mvc\Model\TransactionInterface](/en/3.1/api/Phalcon_Mvc_Model_TransactionInterface) $transaction)
...
abstract public static  **cloneResult** ([Phalcon\Mvc\ModelInterface](/en/3.1/api/Phalcon_Mvc_ModelInterface) $base, *array* $data, [*mixed* $dirtyState])
...
abstract public static  **query** ([[Phalcon\DiInterface](/en/3.1/api/Phalcon_DiInterface) $dependencyInjector])
...
abstract public  **appendMessage** ([Phalcon\Mvc\Model\MessageInterface](/en/3.1/api/Phalcon_Mvc_Model_MessageInterface) $message)

...
public [Phalcon\Cli\Router\Route](/en/3.1/api/Phalcon_Cli_Router_Route) **beforeMatch** (*callback* $callback)
...
public [Phalcon\Cli\Router\Route](/en/3.1/api/Phalcon_Cli_Router_Route) **convert** (*string* $name, *callable* $converter)

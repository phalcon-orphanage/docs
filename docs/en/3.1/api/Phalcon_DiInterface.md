...
abstract public  **setRaw** (*mixed* $name, [Phalcon\Di\ServiceInterface](/en/3.1/api/Phalcon_Di_ServiceInterface) $rawDefinition)
...
abstract public static  **setDefault** ([Phalcon\DiInterface](/en/3.1/api/Phalcon_DiInterface) $dependencyInjector)

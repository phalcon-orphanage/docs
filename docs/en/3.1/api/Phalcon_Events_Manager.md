...
*implements* [Phalcon\Events\ManagerInterface](/en/3.1/api/Phalcon_Events_ManagerInterface)
...
final public *mixed* **fireQueue** ([SplPriorityQueue](http://php.net/manual/en/class.splpriorityqueue.php) | *array* $queue, [Phalcon\Events\Event](/en/3.1/api/Phalcon_Events_Event) $event)

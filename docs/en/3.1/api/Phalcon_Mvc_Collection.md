...
*implements* [Phalcon\Mvc\EntityInterface](/en/3.1/api/Phalcon_Mvc_EntityInterface), [Phalcon\Mvc\CollectionInterface](/en/3.1/api/Phalcon_Mvc_CollectionInterface), [Phalcon\Di\InjectionAwareInterface](/en/3.1/api/Phalcon_Di_InjectionAwareInterface), [Serializable](http://php.net/manual/en/class.serializable.php)
...
## Methods
final public  **__construct** ([[Phalcon\DiInterface](/en/3.1/api/Phalcon_DiInterface) $dependencyInjector], [[Phalcon\Mvc\Collection\ManagerInterface](/en/3.1/api/Phalcon_Mvc_Collection_ManagerInterface) $modelsManager])
...
protected  **setEventsManager** ([Phalcon\Mvc\Collection\ManagerInterface](/en/3.1/api/Phalcon_Mvc_Collection_ManagerInterface) $eventsManager)
...
public static  **cloneResult** ([Phalcon\Mvc\CollectionInterface](/en/3.1/api/Phalcon_Mvc_CollectionInterface) $collection, *array* $document)

Returns a cloned collection



protected static *array* **_getResultset** (*array* $params, [Phalcon\Mvc\Collection](/en/3.1/api/Phalcon_Mvc_Collection) $collection, *MongoDb* $connection, *boolean* $unique)

Returns a collection resultset



protected static *int* **_getGroupResultset** (*array* $params, [Phalcon\Mvc\Collection](/en/3.1/api/Phalcon_Mvc_Collection) $collection, *MongoDb* $connection)

Perform a count over a resultset



final protected *boolean* **_preSave** ([Phalcon\DiInterface](/en/3.1/api/Phalcon_DiInterface) $dependencyInjector, *boolean* $disableEvents, *boolean* $exists)
...
protected  **addBehavior** ([Phalcon\Mvc\Collection\BehaviorInterface](/en/3.1/api/Phalcon_Mvc_Collection_BehaviorInterface) $behavior)

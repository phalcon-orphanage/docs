...
*implements* [Phalcon\Db\ResultInterface](/en/3.1/api/Phalcon_Db_ResultInterface)
...
## Methods
public  **__construct** ([Phalcon\Db\AdapterInterface](/en/3.1/api/Phalcon_Db_AdapterInterface) $connection, [PDOStatement](http://php.net/manual/en/class.pdostatement.php) $result, [*string* $sqlStatement], [*array* $bindParams], [*array* $bindTypes])

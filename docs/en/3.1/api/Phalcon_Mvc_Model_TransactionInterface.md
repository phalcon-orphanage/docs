...
## Methods
abstract public  **setTransactionManager** ([Phalcon\Mvc\Model\Transaction\ManagerInterface](/en/3.1/api/Phalcon_Mvc_Model_Transaction_ManagerInterface) $manager)
...
abstract public  **setRollbackedRecord** ([Phalcon\Mvc\ModelInterface](/en/3.1/api/Phalcon_Mvc_ModelInterface) $record)

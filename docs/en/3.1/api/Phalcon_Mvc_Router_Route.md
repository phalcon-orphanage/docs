...
*implements* [Phalcon\Mvc\Router\RouteInterface](/en/3.1/api/Phalcon_Mvc_Router_RouteInterface)
...
public  **setGroup** ([Phalcon\Mvc\Router\GroupInterface](/en/3.1/api/Phalcon_Mvc_Router_GroupInterface) $group)

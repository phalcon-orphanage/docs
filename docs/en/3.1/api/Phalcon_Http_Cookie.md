...
*implements* [Phalcon\Http\CookieInterface](/en/3.1/api/Phalcon_Http_CookieInterface), [Phalcon\Di\InjectionAwareInterface](/en/3.1/api/Phalcon_Di_InjectionAwareInterface)
...
public [Phalcon\Http\Cookie](/en/3.1/api/Phalcon_Http_Cookie) **setValue** (*string* $value)

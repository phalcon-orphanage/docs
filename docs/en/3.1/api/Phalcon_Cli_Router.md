...
*implements* [Phalcon\Di\InjectionAwareInterface](/en/3.1/api/Phalcon_Di_InjectionAwareInterface)
...
public [Phalcon\Cli\Router\Route](/en/3.1/api/Phalcon_Cli_Router_Route) **add** (*string* $pattern, [*string/array* $paths])
...
public [Phalcon\Cli\Router\Route](/en/3.1/api/Phalcon_Cli_Router_Route) **getRouteById** (*int* $id)

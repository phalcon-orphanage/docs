...
protected  **prepareLabel** ([Phalcon\Validation](/en/3.1/api/Phalcon_Validation) $validation, *mixed* $field)

Prepares a label for the field.



protected  **prepareMessage** ([Phalcon\Validation](/en/3.1/api/Phalcon_Validation) $validation, *mixed* $field, *mixed* $type, [*mixed* $option])

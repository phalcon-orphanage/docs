...
*implements* [Phalcon\Mvc\UrlInterface](/en/3.1/api/Phalcon_Mvc_UrlInterface), [Phalcon\Di\InjectionAwareInterface](/en/3.1/api/Phalcon_Di_InjectionAwareInterface)

...
*implements* [Phalcon\DispatcherInterface](/en/3.1/api/Phalcon_DispatcherInterface), [Phalcon\Di\InjectionAwareInterface](/en/3.1/api/Phalcon_Di_InjectionAwareInterface), [Phalcon\Events\EventsAwareInterface](/en/3.1/api/Phalcon_Events_EventsAwareInterface)

...
protected  **_watermark** ([Phalcon\Image\Adapter](/en/3.1/api/Phalcon_Image_Adapter) $image, *mixed* $offsetX, *mixed* $offsetY, *mixed* $opacity)
...
protected  **_mask** ([Phalcon\Image\Adapter](/en/3.1/api/Phalcon_Image_Adapter) $image)

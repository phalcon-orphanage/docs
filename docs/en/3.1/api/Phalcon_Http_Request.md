...
*implements* [Phalcon\Http\RequestInterface](/en/3.1/api/Phalcon_Http_RequestInterface), [Phalcon\Di\InjectionAwareInterface](/en/3.1/api/Phalcon_Di_InjectionAwareInterface)

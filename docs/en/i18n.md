...
##### This guide is not intended to be a complete documentation of the [intl](http://pecl.php.net/package/intl) extension. Please visit its the [documentation](http://www.php.net/manual/en/book.intl.php) of the extension for a reference. ##### {.alert .alert-warning}

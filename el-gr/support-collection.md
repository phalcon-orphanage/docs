...
Όταν εγκαθιστάτε το αντικείμενο μπορείτε να καθορίσετε μια δεύτερη παράμετρο `bool`, η οποία θα ελέγχει το κλειδί που ψάχνει στο αντικείμενο. By default `$insensitive` is set to `true`, making searches in the collection case-insensitive. Setting this value to `false` will make the search for the element in a case-sensitive manner.
...
- ανάθηση της τιμής στην ιδιότητα
- `__set()`
- ανάθεση στο πίνακα
- `offsetSet()`
- `set()`

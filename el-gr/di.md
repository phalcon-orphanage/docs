...
| cookies            | HTTP Cookies Management Service       | [Phalcon\Http\Response\Cookies](api/Phalcon_Http_Response_Cookies)                  |  Ναι   |
| crypt              | Encrypt/Decrypt data                  | [Phalcon\Crypt](api/Phalcon_Crypt)                                                    |  Ναι   |
| db                 | Low-Level Database Connection Service | [Phalcon\Db](api/Phalcon_Db)                                                          |  Ναι   |
| dispatcher         | Controllers Dispatching Service       | [Phalcon\Mvc\Dispatcher](api/Phalcon_Mvc_Dispatcher)                                 |  Ναι   |
| eventsManager      | Events Management Service             | [Phalcon\Events\Manager](api/Phalcon_Events_Manager)                                 |  Ναι   |
| escaper            | Contextual Escaping                   | [Phalcon\Escaper](api/Phalcon_Escaper)                                                |  Ναι   |
...
| filter             | Input Filtering Service               | [Phalcon\Filter\FilterLocator](api/Phalcon_Filter_FilterLocator)                     |  Ναι   |
...
| response           | HTTP Response Environment Service     | [Phalcon\Http\Response](api/Phalcon_Http_Response)                                   |  Ναι   |
| router             | Routing Service                       | [Phalcon\Mvc\Router](api/Phalcon_Mvc_Router)                                         |  Ναι   |
| security           | Security helpers                      | [Phalcon\Security](api/Phalcon_Security)                                              |  Ναι   |
| session            | Session Service                       | [Phalcon\Session\Adapter\Files](api/Phalcon_Session_Adapter_Files)                  |  Ναι   |
| sessionBag         | Session Bag service                   | [Phalcon\Session\Bag](api/Phalcon_Session_Bag)                                       |  Ναι   |
...
| url                | URL Generator Service                 | [Phalcon\Url](api/Phalcon_Url)                                                        |  Ναι   |
| viewCache          | Cache backend for views fragments     | None                                                                                   |  Όχι   |

...
Phalcon\Db and its related classes provide a simple SQL database interface for Phalcon Framework. The Phalcon\Db is the basic class you use to connect your PHP application to an RDBMS. Υπάρχει μια διαφορετική προσαρμογέα τάξη για κάθε εμπορικό σήμα RDBMS.

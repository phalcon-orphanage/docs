...
Ενα αίτημα νέας λειτουργικότητας θα απορριφθεί **αν**: * Η νέα λειτουργηκότητα κάνει το πλαίσιο αργό * Η νέα λειτουργηκότητα δεν παρέχει οποιαδήποτε πρόσθετη αξία στο πλαίσιο * Η αίτηση νέας λειτουργηκότητας δεν είναι σαφής, κακή τεκμηρίωση, ασαφής εξήγηση, κλπ. * Η αίτηση νέας λειτουργηκότητας δεν ακολουθεί τη φιλοσοφία και τις οδηγίες του πλαισίου * The NFR affects/breaks applications developed in current/older versions of the framework * The original poster does not provide feedback/input when requested * Είναι αδύνατο να αναπτυχθεί τεχνολογικά * It can only be used in the development/testing stages * Submitted/proposed classes/components don't follow the [Single Responsibility Principle](https://en.wikipedia.org/wiki/Single_responsibility_principle) * Χρησιμοποιεί στατικές μεθόδους - (δεν επιτρέπονται)

Για να στείλετε ένα αίτημα νέας λειτουργηκότητας (NFR), δε χρειάζεται να παρέχετε Zephir ή C κώδικα ή να αναπτύξετε τη λειτουργικότητα. Οι αιτήσεις νέας λειτουργηκότητας εξηγούν τον στόχο και εφαρμογή τους και ξεκινούν μια συζήτηση σχετικά με τον καλύτερο τρόπο της ανάπτυξης τους.

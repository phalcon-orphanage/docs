...
- Come parte del report, ti pregiamo di includere informazioni aggiuntive come il sistema operativo, la PHP versione, ka versione du Phalcon, il web server, la memoria, ecc.
...
- [Generare un backtrace gdb](https://bugs.php.net/bugs-generating-backtrace.php)
- [Generare un backtrace, con un compilatore, in Win32](https://bugs.php.net/bugs-generating-backtrace-win32.php)
- [Simboli di debug](https://github.com/oerdnj/deb.sury.org/wiki/Debugging-symbols)
- [Compilazione PHP](https://www.phpinternalsbook.com/build_system/building_php.html)

<a name='pull-request-checklist'></a>

## Checklist per una richiesta di "Pull"
...
- Rimuovere qualsiasi cambiamento ai file `ext/kernel`, `*. zep.c` e `*. zep.h` prima di inviare la richiesta di "pull"
...
- Un aggiornamento per `CHANGELOG.md`
- Unit Tests
- Documentazione o esempi di utilizzo
...
## Richiedere delle caratteristiche

...
| Descrizione           | Parte dell'Url |
| --------------------- | -------------- |
| **Phalcon Directory** | blog           |
| **Controllore**       | posts          |
| **Azione**            | show           |
| **Parametro**         | 2015           |
| **Parametro**         | the-post-title |
...
class PostsController extends Controller
{
    ...
    public function showAction($year = 2015, $postTitle = 'Un titolo predefinito')
    {
...
class PostsController extends Controller
{
    ...
    {
        $this->flash->error(
            "Tu non hai il permesso per accedere a questa area"
        );

        // Inoltra flusso ad un'altra azione
...
## Usare i servizi come controllore

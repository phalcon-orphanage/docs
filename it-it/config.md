...
| [Phalcon\Config\Adapter\Json](api/Phalcon_Config_Adapter_Json) | Utilizza i file JSON per memorizzare le impostazioni.                                            |
...
| [Phalcon\Config\Adapter\Yaml](api/Phalcon_Config_Adapter_Yaml) | Utilizza i file YAML per memorizzare le impostazioni.                                            |
...
// Utilizziamo il punto come delimitatore
$config->path('test.parent.property2');    // yeah
$config->path('database.host', null, '.'); // localhost

$config->path('test.parent'); // Phalcon\Config

// Utilizziamo la slash ( / ) come delimitatore. Può anche essere specificato un valore predefinito e 
// verranno restituiti se l'opzione di configurazione non esiste.
...
## Iniezione delle dipendenze della configurazioni

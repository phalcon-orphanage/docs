...
| Adapter                                                                         | Descrizione                                          | Info                                          | Required Extensions                                 |
| ------------------------------------------------------------------------------- | ---------------------------------------------------- | --------------------------------------------- | --------------------------------------------------- |
...
There are many backend adapters (see [Backend Adapters](#adapters-backend)). Quello che si usa dipenderà dalle esigenze dell'applicazione. The following example loads the Backend Cache Adapter class using `adapter` option, if frontend will be provided as array it will call Frontend Cache Factory

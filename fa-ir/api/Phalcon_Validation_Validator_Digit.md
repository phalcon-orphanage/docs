...
language: 'fa-ir'
version: '4.0'
title: 'فالکن\اعتبار سنجی\ تأییدکننده\رقمی'
---
...
[سورس کد در گیت هاب](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/validation/validator/digit.zep)

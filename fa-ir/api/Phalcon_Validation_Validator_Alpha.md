...
language: 'fa-ir'
version: '4.0'
title: 'فالکون/اعتبار سنجی/تایید کنندگان/آلفا'
---
...
[سورس کد در گیت هاب](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/validation/validator/alpha.zep)

...
在上面的例子中，我们发现一些注释中的注释，一个注释单元语法如下：
...
然而，为了使代码更容易维护和理解，我们推荐把注释参数放在注释块的最后：
...
--------------------
注释单元可以有参数也可以没有。参数因为简单的文字(strings, number, boolean, null)，数组，哈希列表或者其他注释：

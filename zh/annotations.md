...
在类、方法和属性中从文档代码块读取注释。 注释可以放置在文档块的任何位置:
...
有很多注释适配器可用 （请参阅 [Adapters](#adapters)）。 您使用将取决于您的应用程序的需要。 实例化此类 adapter 的传统方法是，如下所示：
...
注释可能有参数也可能没有 A parameter could be a simple literal (strings, number, boolean, null), an array, a hashed list or other annotation:

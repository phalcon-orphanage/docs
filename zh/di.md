<div class='article-menu'>
  <ul>
    <li>
      <a href="#di-service-location">依赖注入 / 服务定位</a> <ul>
        <li>
          <a href="#di-explained">DI 解释</a>
        </li>
        <li>
          <a href="#registering-services">在容器中注册服务</a> <ul>
            <li>
              <a href="#simple-registration">简单的注册</a> <ul>
                <li>
            ...
            <li>
              <a href="#complex-registration">复杂的注册</a> <ul>
                <li>
        ...
        <li>
          <a href="#resolving-services">解析服务</a> <ul>
            <li>
              <a href="#events">事件</a>
            </li>
          </ul>

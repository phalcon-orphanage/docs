...
public  **__construct** (*array* $columnTypes, [:doc:`\\Phalcon\\Db\\ResultInterface <_Phalcon_Db_ResultInterface>` $result], [:doc:`\\Phalcon\\Cache\\BackendInterface <_Phalcon_Cache_BackendInterface>` $cache])

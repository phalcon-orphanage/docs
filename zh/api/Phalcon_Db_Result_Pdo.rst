...
public  **__construct** (:doc:`\\Phalcon\\Db\\AdapterInterface <_Phalcon_Db_AdapterInterface>` $connection, *\PDOStatement* $result, [*string* $sqlStatement], [*array* $bindParams], [*array* $bindTypes])

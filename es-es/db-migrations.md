...
| `options`    | Un array con un conjunto de opciones para crear la tabla. These options are often related to the database system in which the migration was generated. |    Si    |
...
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- |:--------:|
| `type`          | Tipo de columna. Must be a [Phalcon\Db\Column](api/Phalcon_Db) constant (see below)                                                                      |    No    |
...
| `unsigned`      | INTEGER columns may be signed or unsigned. Esta opción no se aplica a otros tipos de columnas                                                              |    Si    |
...
| ------------------- | --------------------------------------------------------------------------------------------------- |:--------:| ---------------- |
| `referencedTable`   | It's auto-descriptive. It refers to the name of the referenced table.                               |    No    | Todos            |
...
| `referencedSchema`  | The referenced table maybe is on another schema or database. This option allows you to define that. |    Si    | Todos            |

...
| Insert/Update | `onValidationFails`        |  Si   | Se ejecuta después de un validador de integridad falla                                                |
| Insert/Update | `prepareSave`              |  No   | Es ejecutado antes de guardar y permite la manipulación de datos                                      |

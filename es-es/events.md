...
| [Consulta](request)             | `request:afterAuthorizationResolve`  |
| [Consulta](request)             | `request:beforeAuthorizationResolve` |
| [Respuesta](response)           | `response:afterSendHeaders`          |
| [Respuesta](response)           | `response:beforeSendHeaders`         |

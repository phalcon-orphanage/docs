...
[Código fuente en GitHub](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/db.zep)

Phalcon\Db and its related classes provide a simple SQL database interface for Phalcon Framework. The Phalcon\Db is the basic class you use to connect your PHP application to an RDBMS. Existe una clase de adaptador diferente por cada marca de RDBMS.
...
Activa o desactiva las opciones en el componente de base de datos
...
> **NOTA**: Esta guía no pretende ser una documentación completa de la extensión [intl](https://pecl.php.net/package/intl). Por favor visita la [documentación oficial](https://secure.php.net/manual/en/book.intl.php) de la extensión como referencia.
{: .alert .alert-warning }
...
Parte de la creación de una aplicación regionalizada es producir, mensajes enlazados que sean neutros al idioma. El [MessageFormatter](https://secure.php.net/manual/en/class.messageformatter.php) permite generar estos mensajes.
...
La clase [Collator](https://secure.php.net/manual/es/class.collator.php) proporciona capacidad de comparación de cadenas con el soporte de ordenamientos sensible a la configuración regional. Revise los ejemplos a continuación en el uso de esta clase:
...
[Transliterator](https://secure.php.net/manual/es/class.transliterator.php) proporciona la transliteración de cadenas de texto:

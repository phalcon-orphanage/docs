...
> **NOTE**: This guide is not intended to be a complete documentation of the [intl](https://pecl.php.net/package/intl) extension. Por favor visita la [documentación oficial](https://secure.php.net/manual/en/book.intl.php) de la extensión como referencia.
{: .alert .alert-warning }

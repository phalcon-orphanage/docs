...
## Wann sollte man Cache implementieren?
...
// Ausgabe Frontend erstellen. Dateien für 2 Tage cachen
...
// Die Kmponente  erstelen, welche die 'Ausgabe' in eine 'Datei' cachen wird
// Cache Datei Verzeichnis festlegen - Es ist wichtig, dass es mit einem  '/' endet
$cache = new BackFile(
    $frontCache,
    [
        'cacheDir' => '../app/cache/',
...
## Zwischenspeichern der Ausgabe Fragmente
...
## Beliebige Daten zwischenspeichern
...
## Löschen von Daten aus dem cache
...
| ------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Phalcon\Cache\Frontend\Output](api/Phalcon_Cache_Frontend_Output)     | Eingabedaten aus standard PHP-Ausgabe lesen.                                                                                                                   |
...
### Implementierung von eigenen Frontend Adaptern
...
| [Phalcon\Cache\Backend\Libmemcached](api/Phalcon_Cache_Backend_Libmemcached) | Speichert Daten in einem Memcached-Server.           | [Memcached](https://www.php.net/memcached) | [Memcached](https://pecl.php.net/package/memcached) |
| [Phalcon\Cache\Backend\Memcache](api/Phalcon_Cache_Backend_Memcache)         | Speichert Daten in einem Memcached-Server.           | [Memcache](https://www.php.net/memcache)   | [Memcache](https://pecl.php.net/package/memcache)   |
...
There are many backend adapters (see [Backend Adapters](#adapters-backend)). Welche Sie verwenden, hängt von den Anforderungen Ihrer Anwendung ab. The following example loads the Backend Cache Adapter class using `adapter` option, if frontend will be provided as array it will call Frontend Cache Factory
...
### Implementierung von eigenen Backend Adaptern
...
### Datei Back-End Optionen

This backend will store cached content into files in the local server. The available options for this backend are:

| Option     | Beschreibung                                                                        |
| ---------- | ----------------------------------------------------------------------------------- |
| `prefix`   | Ein Präfix, das auf die Cacheschlüssel automatisch vorangestellt ist.               |
| `cacheDir` | Ein beschreibbares Verzeichnis in das zwischengespeicherte Dateien abgelegt werden. |

<a name='adapters-backend-libmemcached'></a>

### Libmemcached Back-End-Optionen
...
| Option   | Beschreibung                                                                                                |
| -------- | ----------------------------------------------------------------------------------------------------------- |
| `host`   | Der `Memcached`-Host.                                                                                       |
| `port`   | Der `Memcached`-Port.                                                                                       |
...
// Die Cache Einstellung für memcached Verbindungsoptionen

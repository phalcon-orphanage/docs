...
| Filter                                                                | Beschreibung                                                                                                                       |
| --------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- |
| [Phalcon\Assets\Filters\Jsmin](api/Phalcon_Assets_Filters_Jsmin)   | Minimiert JavaScript indem überflüssige Zeichen entfernt werden, welche durch den Javascript Interpreter/Compiler ignoriert werden |

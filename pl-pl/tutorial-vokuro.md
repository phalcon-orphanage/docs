...
| Kontroler     | Akcja            | Route                     | Description                                 |
| ------------- | ---------------- | ------------------------- | ------------------------------------------- |
| `About`       | `index`          | `/about`                  | Shows the `about` page                      |
| `Indeks`      | `index`          | `/`                       | Default action - home page                  |
...
| Kontroler     | Akcja            | View                           | Description                                 |
| ------------- | ---------------- | ------------------------------ | ------------------------------------------- |
| `About`       | `index`          | `/about/index.volt`            | Shows the `about` page                      |
| `Indeks`      | `index`          | `/index/index.volt`            | Default action - home page                  |
...
| Nazwa             | Source field | Target field | Model             |
| ----------------- | ------------ | ------------ | ----------------- |

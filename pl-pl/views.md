...
| ------------------ | ----------------------------------- |:--------:|
| `afterRender`      | After completing the render process |   Nie    |
| `afterRenderView`  | After rendering an existing view    |   Nie    |
| `beforeRender`     | Before starting the render process  |   Tak    |
| `beforeRenderView` | Before rendering an existing view   |   Tak    |
| `notFoundView`     | When a view was not found           |   Nie    |

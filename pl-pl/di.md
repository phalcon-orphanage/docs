...
| Nazwa                | Object                                                              | Shared | Description                  |
| -------------------- | ------------------------------------------------------------------- | ------ | ---------------------------- |
...
| `crypt`              | [Phalcon\Encryption\Crypt](encryption-crypt)                      | Tak    | Encrypt/Decrypt              |
...
| `escaper`            | [Phalcon\Html\Escaper](html-escaper)                              | Tak    | Escaper                      |
...
| `filter`             | [Phalcon\Filter\Filter](filter-filter)                            | Tak    | Filtering / Sanitizing       |
| `helper`             | [Phalcon\Support\HelperFactory](support-helper)                   | Tak    | String, array etc. helpers   |

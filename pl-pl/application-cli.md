...
| Zdarzenie           | Stop | Description                                             |
| ------------------- |:----:| ------------------------------------------------------- |
| `afterHandleTask`   | Tak  | Called after the task is handled                        |
| `afterStartModule`  | Tak  | Called after processing a module (if modules are used)  |
| `beforeHandleTask`  | Nie  | Called before the task is handled                       |
| `beforeStartModule` | Tak  | Called before processing a module (if modules are used) |
| `boot`              | Tak  | Called when the application boots                       |

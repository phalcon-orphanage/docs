...
*extends* abstract class [Phalcon\Validation\CombinedFieldsValidator](/en/3.2/api/Phalcon_Validation_CombinedFieldsValidator)
...
protected **isUniqueness** ([Phalcon\Validation](/en/3.2/api/Phalcon_Validation) $validation, *mixed* $field)

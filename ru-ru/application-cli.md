...
| Событие             | Stop | Описание                                                |
| ------------------- |:----:| ------------------------------------------------------- |
| `afterHandleTask`   |  Да  | Called after the task is handled                        |
| `afterStartModule`  |  Да  | Called after processing a module (if modules are used)  |
| `beforeHandleTask`  | Нет  | Called before the task is handled                       |
| `beforeStartModule` |  Да  | Called before processing a module (if modules are used) |
| `boot`              |  Да  | Called when the application boots                       |

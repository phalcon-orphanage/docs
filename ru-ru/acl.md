...
| Название события    | Срабатывает                                              | Can stop role? |
| ------------------- | -------------------------------------------------------- |:--------------:|
| `afterCheckAccess`  | Triggered after checking if a role/component has access  |      Нет       |
| `beforeCheckAccess` | Triggered before checking if a role/component has access |       Да       |

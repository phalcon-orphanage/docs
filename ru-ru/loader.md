...
| Событие            | Описание                                                                                | Можно остановить операцию? |
| ------------------ | --------------------------------------------------------------------------------------- | -------------------------- |
| `afterCheckClass`  | Fires at the end of the end of the auto load process when the class has not been found. | Нет                        |
| `beforeCheckClass` | Fires at the beginning of the auto load process, before checking for the class.         | Да                         |
| `beforeCheckPath`  | Fires before checking a directory for a class file.                                     | Да                         |
| `pathFound`        | Fires when the loader locates a class file or a file in a registered directory          | Да                         |

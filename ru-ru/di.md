...
| `crypt`              | [Phalcon\Encryption\Crypt](encryption-crypt)                      | Да     | Encrypt/Decrypt              |
...
| `escaper`            | [Phalcon\Html\Escaper](html-escaper)                              | Да     | Escaper                      |
...
| `filter`             | [Phalcon\Filter\Filter](filter-filter)                            | Да     | Filtering / Sanitizing       |
| `helper`             | [Phalcon\Support\HelperFactory](support-helper)                   | Да     | String, array etc. helpers   |

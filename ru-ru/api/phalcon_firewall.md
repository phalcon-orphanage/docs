...
[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ pageVersion }}.0/phalcon/firewall/adapter/abstractadapter.zep)
...
[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ pageVersion }}.0/phalcon/firewall/adapter/acl.zep)
...
[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ pageVersion }}.0/phalcon/firewall/adapter/adapterinterface.zep)
...
[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ pageVersion }}.0/phalcon/firewall/adapter/annotations.zep)
...
[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ pageVersion }}.0/phalcon/firewall/adapter/micro/acl.zep)
...
[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ pageVersion }}.0/phalcon/firewall/exception.zep)

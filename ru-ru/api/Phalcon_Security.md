...
- [Phalcon\Security\Security](#security-security)

<h1 id="security-exception">Class Phalcon\Security\Exception</h1>

[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/security/exception.zep)
...
[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/security/random.zep)
...
<h1 id="security-security">Class Phalcon\Security\Security</h1>

[Исходный код на GitHub](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/security/security.zep)

| Namespace | Phalcon\Security | | Uses | Phalcon\DiInterface, Phalcon\Security\Random, Phalcon\Security\Exception, Phalcon\Di\InjectionAwareInterface, Phalcon\Session\ManagerInterface | | Implements | InjectionAwareInterface |

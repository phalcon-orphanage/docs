...
| Название | Описание                                                                                                                                                                 |
| -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| Шифр     | The cipher is one of the encryption algorithms supported by openssl. You can see a list [here](https://secure.php.net/manual/en/function.openssl-get-cipher-methods.php) |

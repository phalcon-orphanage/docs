...
| Filter                                                                | Description                                                                                               |
| --------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------- |
| [Phalcon\Assets\Filters\Jsmin](api/Phalcon_Assets_Filters_Jsmin)   | Minifies JavaScript en supprimant les caractères qui sont ignorés par Javascript interprètes/compilateurs |
| [Phalcon\Assets\Filters\Cssmin](api/Phalcon_Assets_Filters_Cssmin) | Minifies CSS en supprimant les caractères qui sont ignorés par les navigateurs                            |
 ...
 * Ce fichier est inclus dans le routeur de définition de service.
 */

...
Ang unang file na kailangan mong gawin ay ang bootstrap file. This file acts as the entry-point and configuration for your application. In this file, you can implement initialization of components as well as application behavior.
...
Next, we register a base URI so that all URIs generated by Phalcon include the "tutorial" folder we setup earlier. Ito ay magiging importanti mamaya sa pagtuturo na ito kapag ginagamit namin ang klase `Phalcon\Tag` upang bumuo ng isang hyperlink.

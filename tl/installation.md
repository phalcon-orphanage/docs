<div class='article-menu'>
  <ul>
    <li>
      <a href="#requirements">Mga kinakailangan</a> <ul>
        <li>
    ...
    <li>
      <a href="#installation">Instalasyon</a> <ul>
        <li>
          <a href="#installation-linux">Linux</a> <ul>
            <li>
              <a href="#installation-linux-debian">Nakabaseng pamamahagi ng DEB (Debian, Ubuntu, etc.)</a> <ul>
                <li>
                  <a href="#installation-linux-debian-repository">Instalasyon ng repositaryo</a> <ul>
                    <li>
                      <a href="#installation-linux-debian-repository-stable">Matatag na paglabas</a>
                    </li>
                    <li>
                      <a href="#installation-linux-debian-repository-nightly">Panggabing mga paglabas</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="#installation-linux-debian-phalcon">Instalasyon nga Phalcon</a> <ul>
                    <li>
                ...
                <li>
                  <a href="#installation-linux-debian-other-ppa">Karagdagang mga PPAs</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="#installation-linux-rpm">Nakabaseng pamamahagi ng RPM (CentOS, Fedora, etc.)</a> <ul>
                <li>
                  <a href="#installation-linux-rpm-repository">Inslatalsyon ng repositaryo</a> <ul>
                    <li>
                      <a href="#installation-linux-rpm-repository-stable">Matatag na paglabas</a>
                    </li>
                    <li>
                      <a href="#installation-linux-rpm-repository-nightly">Panggabing mga paglabas</a>
                    </li>
                  </ul>
                </li>
                <li>
                  <a href="#installation-linux-rpm-phalcon">Instalasyong ng Phalcon</a> <ul>
                    <li>
                ...
                <li>
                  <a href="installation-linux-rpm-other-rpm">Karagdagang mga RPMs</a>
                </li>
              </ul>
            </li>
            <li>
              <a href="#installation-freebsd">LibrengBSD</a>
            </li>
            <li>
        ...
        <li>
          <a href="#installation-macos">MacOS</a> <ul>
            <li>
              <a href="#installation-macos-brew">Pagluto</a>
            </li>
            <li>
              <a href="#installation-macos-macports">Mga Daungan ng Mac</a>
            </li>
          </ul>
        </li>
        <li>
        ...
        <li>
          <a href="#installation-sources">Iponin mula sa mga pinagkukunan</a>
        </li>
        <li>
          <a href="#installation-sources-advanced">Naunang Pag-iipon</a>
        </li>
      </ul>
    </li>
  </ul>
...
Ang Phalco ay nangangailangan sa PHP upang tumakbo. Ang maluwag na pagkakpares ng disenyo nito ay nagbibigay-daan sa mga nagdedevelop na i-install ang Phalcon at gamitin ang gamit nito nang walang karagdagang na ekstensyon. Ang ilang mga bahagi ay may mga dumedepende sa iba pang mga ekstensyon. Halimbawa ang paggamit ng pagkakakonekta sa database ay nangangailangan ng ekstensyon ng ` php_pdo`. Kung ang iyong RDBMS ay MySql/MariaDb o Aurora na database, kakailanganin mo rin ang `php_mysqlnd` na ekstensyon din. Gayundin, ang paggamit ng isang PostgreSql na database na may Phalcon ay nangangailangan ng `php_pgsql` na ekstensyon.

<a name='requirements-hardware'></a>

## Hardware

Ang Phalcon ay dinisenyo upang gamitin ng maliit na mga mapagkukunan hangga't maaari, habang nag-aalok ng mataas na pagganap. Kahit na sinubukan namin ang Phalcon sa iba't ibang mga mura na environment, (tulad ng 0.25GB RAM, 0.5 CPU), ang hardware na iyong pipiliin ay depende sa iyong mga pangangailangan ng aplikasyon.

Ang aming website at blog (pati na rin ang iba pang mga site) ay naka-host sa Amazon VM na may 512MB RAM at 1 vCPU.
...
Kailangan ng Phalcon ang mga sumusunod na ekstensyon upang tumakbo (hindi gaano):
...
### Opsyonal na dumedepende sa mga pangangailangan ng iyong aplikasyon

- Ang [PDO](http://php.net/manual/en/book.pdo.php) na Ekstensyon pati na rin ang may-katuturang RDBMS tiyak na ekstensyon (ibig sabihin [MySQL](http://php.net/manual/en/ref.pdo-mysql.php), [PostgreSql](http://php.net/manual/en/ref.pdo-pgsql.php) atbp.)

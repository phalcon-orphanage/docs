...
Next, we register a base URI so that all URIs generated by Phalcon match the application's base path of "/". Це стане важливим пізніше, коли ми використовуємо клас `phalcon\тег`, щоб створити гіперпосилання.

...
Edit the `php.ini` file, it is located at `C:\xampp\php\php.ini`. Bisa diedit dengan Notepad atau program serupa. We recommend [Notepad++](https://notepad-plus-plus.org/) to avoid issues with line endings. Tambahkan pada akhir file:
...
* [Instalasi di WAMP](/4.0/en/webserver-wamp)
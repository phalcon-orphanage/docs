...
[Sumber di GitHub](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/mvc/model/validator/url.zep)

Memungkinkan untuk memvalidasi jika field memiliki format url

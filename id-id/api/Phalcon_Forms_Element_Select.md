...
[Sumber di GitHub](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/forms/element/select.zep)

Komponen PILIH (pilihan) untuk membentuk
...
Mengembalikan pilihan pilihan

public *this* **addOption** (*array* $option)

Menambahkan opsi ke opsi saat ini

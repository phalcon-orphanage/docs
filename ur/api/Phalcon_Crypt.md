...
Throws [Phalcon\Crypt\Mismatch](/[[language]]/[[version]]/api/Phalcon_Crypt_Mismatch)
...
public **setCipher** (*mixed* $cipher): *[Phalcon\Crypt](/[[language]]/[[version]]/api/Phalcon_Crypt)*
...
Throws: [Phalcon\Crypt\Exception](/[[language]]/[[version]]/api/Phalcon_Crypt_Exception)

public **setHashAlgo** (*string* $hashAlgo): *[Phalcon\Crypt](/[[language]]/[[version]]/api/Phalcon_Crypt)*

Set the name of hashing algorithm to calculate the message digest. Throws [Phalcon\Crypt\Exception](/[[language]]/[[version]]/api/Phalcon_Crypt_Exception) if the algorithm is not supported by the system

public **setKey** (*mixed* $key): *[Phalcon\Crypt](/[[language]]/[[version]]/api/Phalcon_Crypt)*
...
See also: : [Phalcon\Security\Random](/[[language]]/[[version]]/api/Phalcon_Security_Random)

public **setPadding** (*mixed* $scheme): *[Phalcon\Crypt](/[[language]]/[[version]]/api/Phalcon_Crypt)*

Changes the padding scheme used

public **useSigning** (*boolean* $useSigning): *[Phalcon\Crypt](/[[language]]/[[version]]/api/Phalcon_Crypt)*

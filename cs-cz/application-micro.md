...
| Event | Description                                    |
| ----- | ---------------------------------------------- |
| před  | Before the handler has been executed           |

...
[Phalcon\Db](api/Phalcon_Db) is able to send events to a [EventsManager](events) if it's present. Některé události při vrácení hodnoty false můžou zastavit aktivní operaci. Podporovány jsou následující události:

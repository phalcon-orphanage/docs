...
| ------------------- |:----:| ------------------------------------------------------- |
| `afterHandleTask`   | Ano  | Called after the task is handled                        |
| `afterStartModule`  | Ano  | Called after processing a module (if modules are used)  |
| `beforeHandleTask`  |  Ne  | Called before the task is handled                       |
| `beforeStartModule` | Ano  | Called before processing a module (if modules are used) |
| `boot`              | Ano  | Called when the application boots                       |

...
| Event              | Description                                                                             | Zastaví operaci? |
| ------------------ | --------------------------------------------------------------------------------------- | ---------------- |
| `afterCheckClass`  | Fires at the end of the end of the auto load process when the class has not been found. | Ne               |
| `beforeCheckClass` | Fires at the beginning of the auto load process, before checking for the class.         | Ano              |
| `beforeCheckPath`  | Fires before checking a directory for a class file.                                     | Ano              |
| `pathFound`        | Fires when the loader locates a class file or a file in a registered directory          | Ano              |

...
Edit the `php.ini` file, it is located at `C:\wamp\bin\php\php7.2.18\php.ini`. Soubor může být upraven v libovolném textovém editoru. We recommend Notepad++ to avoid issues with line endings. Přidejte následující řádek na konec souboru:

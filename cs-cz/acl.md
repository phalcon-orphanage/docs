...
| ------------------- | ----------------------------------------------------------- |:----------------:|
| `afterCheckAccess`  | Triggered after checking if a operation/subject has access  |        Ne        |
| `beforeCheckAccess` | Triggered before checking if a operation/subject has access |       Ano        |

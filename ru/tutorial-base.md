...
Next, we register a base URI so that all URIs generated by Phalcon match the application's base path of "/". Это станет важным позже в этом руководстве, когда мы используем класс `Phalcon\Tag` для создания гиперссылки.

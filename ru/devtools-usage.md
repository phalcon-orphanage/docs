...
<div class="alert alert-danger">
    <p>
        Если вы предпочитаете использовать веб-версию вместо консоли <a href="https://blog.phalconphp.com/post/dont-like-command-line-and-consoles-no-problem">эта запись в блоге</a> содержит больше информации.
    </p>
</div>

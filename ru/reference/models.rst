...
.. highlights::
    ...
    Для исключения SQL-инъекция при поиске записей на основе пользовательского ввода или переменных вы должны
    использовать привязку параметров (`Привязка параметров`_).

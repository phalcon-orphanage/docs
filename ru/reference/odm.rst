...
---------------------------
Пространства имен могут быть использованы для того, чтобы избежать колизий имен классов. В этом случае необходимо указать имя соответствующей колекции, используя getSource:

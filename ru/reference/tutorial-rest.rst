...
вторым — обработчик, который, в нашем случае является анонимной функцией. Такой маршрут, как '/api/robots/{id:[0-9]+}'
...
.. code-block:: bash
    ...
    {"status":"ERROR","messages":["Имя робота должно быть уникально"]}
...
микроприложения и язык :doc:`PHQL <phql>`.

...
Требования
-------------
Для запуска инструментов разработчика необходимо установленное расширение Phalcon PHP. Если оно еще не установлено прочитайте инструкции в разделе :doc:`Устанвока <install>`.

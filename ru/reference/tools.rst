Инструмены разработчика Phalcon (Developer Tools)
=================================================
...
.. highlights::
    **ВНИМАНИЕ:** Требуется Phalcon Framework версии 0.5.0 и выше. Так же рекомендуем PHP 5.3.6 и выше.
...
Созданная модель содержит публичные аттрибуты для прямого доступа.
...
При использовании *--get-set* аттрибуты модели будут закрыты для прямого изменения, работа с ними будет только через соответсвющие get и set методы. Такое
поведение позволит изменить бизнес-логику работы модели внутри соответсвющих set/get методов.
...
поиска, для выполнение требуемых действий.
...
Заключение
----------
Phalcon Developer Tools позволяет легко генерировать код для вашего приложения, сокращая время разработки и потенциальные ошибоки.

.. _блогозапись: http://blog.phalconphp.com/post/23251010409/dont-like-command-line-and-consoles-no-problem

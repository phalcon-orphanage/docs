...
Однако, когда в Google `стали`_ учитывать скорость сайта при ранжировании поиска, производительность стала одним из приоритетов, наряду с функциональностью.
Это еще один способ, который улучшение производительность приложения будет положительно влиять на интернет.
...
------------------------
Для всех фреймворков использовался APC_. Во избежание накладных расходов по возможности был отключен mod-rewrite в Apache.

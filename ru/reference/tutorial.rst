...
В качестве отправной точки для данного урока мы предалгаем следующую структуру:
...
На следующем шаге мы регистрируем сервис 'view', который указывает на папку с файлами 'view' (представлениями). Т.к. данные файлы не относится к классам, они не могут быть подгружены автозагрузчиком.

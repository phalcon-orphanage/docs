...
| 筛选器                                                                   | 描述                                             |
| --------------------------------------------------------------------- | ---------------------------------------------- |
| [Phalcon\Assets\Filters\Jsmin](api/Phalcon_Assets_Filters_Jsmin)   | 通过删除不必要的字符由 Javascript 的口译员编译器忽略人财物 JavaScript |
| [Phalcon\Assets\Filters\Cssmin](api/Phalcon_Assets_Filters_Cssmin) | 通过删除不必要的字符已经被浏览器忽略人财物 CSS                      |

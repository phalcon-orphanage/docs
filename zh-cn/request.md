...
| ---------------------------- | ------------------------------------------------ |:------------------:|
| `afterAuthorizationResolve`  | Fires when the authorization has been resolved   |         否          |
| `beforeAuthorizationResolve` | Fires before the authorization has been resolved |         是的         |

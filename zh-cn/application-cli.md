...
| Event               | Stop | 描述                                                      |
| ------------------- |:----:| ------------------------------------------------------- |
| `afterHandleTask`   |  是的  | Called after the task is handled                        |
| `afterStartModule`  |  是的  | Called after processing a module (if modules are used)  |
| `beforeHandleTask`  |  否   | Called before the task is handled                       |
| `beforeStartModule` |  是的  | Called before processing a module (if modules are used) |
| `boot`              |  是的  | Called when the application boots                       |

...
layout: default language: 'en' version: '4.0' title: 'Phalcon\Forms\ElementInterface'

* * *

# Interface **Phalcon\Forms\ElementInterface**

<a href="https://github.com/phalcon/cphalcon/tree/v3.4.0/phalcon/forms/elementinterface.zep" class="btn btn-default btn-sm">源码在GitHub</a>

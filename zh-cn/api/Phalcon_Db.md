...
layout: default language: 'en' version: '4.0' title: 'Phalcon\Db'

* * *

# Abstract class **Phalcon\Db**

<a href="https://github.com/phalcon/cphalcon/tree/v3.4.0/phalcon/db.zep" class="btn btn-default btn-sm">源码在GitHub</a>

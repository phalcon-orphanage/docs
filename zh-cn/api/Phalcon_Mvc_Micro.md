...
[源码在GitHub](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/mvc/micro.zep)

使用phalcon您可以创建 “类微服务框架” 的应用 通过此途径，您仅需编写少量的代码即可创建一个PHP应用 微服务应用非常适合小型应用、APIs和原型实践

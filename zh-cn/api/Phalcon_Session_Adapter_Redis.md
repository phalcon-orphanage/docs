...
layout: default language: 'en' version: '4.0' title: 'Phalcon\Session\Adapter\Redis'
...
<a href="https://github.com/phalcon/cphalcon/tree/v3.4.0/phalcon/session/adapter/redis.zep" class="btn btn-default btn-sm">源码在GitHub</a>

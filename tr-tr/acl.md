...
| ------------------- | ----------------------------------------------------------- |:-----------------------:|
| `afterCheckAccess`  | Triggered after checking if a operation/subject has access  |          Hayır          |
| `beforeCheckAccess` | Triggered before checking if a operation/subject has access |          Evet           |

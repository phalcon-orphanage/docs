...
[Kaynak kodu GitHub'da](https://github.com/phalcon/cphalcon/tree/v{{ page.version }}.0/phalcon/cache/backend/apc.zep)

Bir APC arka uç kullanarak çıktı parçalarını, PHP verilerini ve ham verileri önbelleğe almaya izin verir
...
APC arka planındaki engeller arka planı engeller
...
// 'my-data' ve diğer tüm kullanılan tuşlar silinir
$cache->flush();

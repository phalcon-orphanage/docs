...
| ------------------- |:-----:| ------------------------------------------------------- |
| `afterHandleTask`   | Evet  | Called after the task is handled                        |
| `afterStartModule`  | Evet  | Called after processing a module (if modules are used)  |
| `beforeHandleTask`  | Hayır | Called before the task is handled                       |

...
| ---------------------------- | ------------------------------------------------ |:------------------:|
| `afterAuthorizationResolve`  | Fires when the authorization has been resolved   |       Hayır        |
| `beforeAuthorizationResolve` | Fires before the authorization has been resolved |        Evet        |

...
| `type`          | Column type. Must be a [Phalcon\Db\Column][db-column] constant (see below for a list)                                 |  Hayır   |
...
| ------------ | ------------------------------------------------------------------------------------------- |:--------:|
| `columns`    | An array with columns defined with [Phalcon\Db\Column][db-column]                         |  Hayır   |
| `indexes`    | An array with indexes defined with [Phalcon\Db\Index][db-index]                           |   Evet   |
| `references` | An array with references (foreign keys) defined with [Phalcon\Db\Reference][db-reference] |   Evet   |
